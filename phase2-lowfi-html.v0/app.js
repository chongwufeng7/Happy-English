...
function childHome() {
  ...
  const percent = Math.min(100, doneCount / Math.max(planTasks.length, 1) * 100);
    ...
    <main class="screen child-home-screen">
      <section class="home-hero-card">
        ...
        <div class="home-hero-copy">
          <h2 class="home-hero-title"><span>Happy</span> 英语</h2>
          <p class="home-hero-tagline">今天也要开心学英语呀！</p>
          <span class="home-theme-pill">本周主题 · ${currentUnit().theme}</span>
        </div>
      ...
      <section class="metrics compact-metrics home-metrics">
        <div class="card metric home-progress-card">
          <img class="home-metric-icon" src="assets/home-ui/progress-clipboard-v1.png" alt="今日进度">
          <div class="home-metric-copy"><div class="metric-line"><span>今日进度</span><strong>${doneCount}/${planTasks.length}</strong></div><div class="progress-track"><i style="width:${percent}%"></i></div></div>
        </div>
        <div class="card metric home-star-card">
          <img class="home-metric-icon" src="assets/home-ui/task-write-star.png" alt="今日星星">
      ...
      <div class="row home-section-heading review-heading"><h2 class="section-title">今日复习</h2><strong>轻松再练一次</strong></div>
...
function childNav(active) {
  ...
  const items = visualHomeNav
    ? [
      ['home', '首页', 'assets/home-ui/task-listen-parrot.png'],
      ['units', '闯关', 'assets/home-ui/task-read-chameleon.png'],
      ['rewards', '奖励', 'assets/home-ui/task-write-star.png']
    ]
    : [
